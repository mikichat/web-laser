    ...
    <main className="min-h-screen bg-slate-950">
      ...
      <section id="equipment" className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: 'TRUMPF TruLaser 5030', type: '파이버 레이저', power: '12kW', size: '3000 x 1500mm', feature: '고출력 파이버' },
              { name: 'AMADA ENSIS-3015AJ', type: '파이버 레이저', power: '9kW', size: '3000 x 1500mm', feature: '고속 절단' },
              { name: 'BYSTRONIC ByStar Fiber', type: '파이버 레이저', power: '6kW', size: '4000 x 2000mm', feature: '대형 판재' },
            ].map((equip, index) => (
